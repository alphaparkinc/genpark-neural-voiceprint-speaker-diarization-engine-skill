# genpark-neural-voiceprint-speaker-diarization-engine-skill
...
> **GenPark AI Agent Skill** -- Neural voiceprint speaker diarization & overlap resolver (PyAnnote style)
